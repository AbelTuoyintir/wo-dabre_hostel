...
<div class="max-w-4xl mx-auto">
    <!-- Header -->
    <div class="mb-4 bg-white rounded-xl shadow-sm border border-gray-100 p-4 flex justify-between items-center">
        <div class="flex items-center">
            <a href="{{ route('agent.hostels.index') }}" class="text-gray-500 hover:text-gray-700 mr-3">
                <i class="fas fa-arrow-left text-xs"></i>
            </a>
            <div>
                <h2 class="text-sm font-semibold text-gray-800">Add New Room</h2>
                <p class="text-xs text-gray-500">Create a new room in your managed hostel</p>
            </div>
        </div>
    </div>
    ...
    <div class="mb-4 bg-purple-50 rounded-lg p-3 border border-purple-100">
        <div class="flex items-start">
            <i class="fas fa-lightbulb text-purple-600 text-xs mt-0.5 mr-2"></i>
            <div>
                <h4 class="text-xs font-medium text-purple-900">Quick Tips</h4>
                <ul class="mt-1 text-[10px] text-purple-700 list-disc list-inside">
                    <li>Room numbers must be unique within each hostel</li>
                    <li>Capacity determines the maximum number of occupants</li>
                    <li>Commission of ₵20.00 will be credited upon room addition</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <form action="{{ route('agent.rooms.store') }}" method="POST" class="p-6" enctype="multipart/form-data">
            @csrf
            ...
            <div class="space-y-6">
                ...
                @if($hostels && $hostels->count() > 0)
                    <div>
                        <h3 class="text-xs font-semibold text-gray-700 uppercase tracking-wider mb-3 flex items-center">
                            <i class="fas fa-building text-purple-600 mr-1.5 text-xs"></i>
                            Hostel Selection
                        </h3>
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                <label for="hostel_id" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                                    Select Hostel <span class="text-red-500">*</span>
                                </label>
                                <select id="hostel_id" name="hostel_id" class="w-full px-3 py-2 text-xs border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500 @error('hostel_id') border-red-500 @enderror" required>
                    ...
                    <div class="bg-yellow-50 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-lg mb-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <p class="text-xs">You don't have any registered hostels yet. Please add a hostel before creating rooms.</p>
                            </div>
                            <a href="{{ route('agent.hostels.create') }}" class="px-3 py-1 bg-yellow-600 text-white text-xs font-medium rounded-lg hover:bg-yellow-700 transition">
                                Add Hostel
                            </a>
                        </div>
                    </div>
                ...
                <div class="pt-2">
                    <h3 class="text-xs font-semibold text-gray-700 uppercase tracking-wider mb-3 flex items-center">
                        <i class="fas fa-info-circle text-purple-600 mr-1.5 text-xs"></i>
                        Basic Information
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <!-- Room Number -->
                        <div>
                            <label for="number" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                                Room Number <span class="text-red-500">*</span>
                            </label>
                            <input type="text" id="number" name="number" value="{{ old('number', old('room_number')) }}"
                                   class="w-full px-3 py-2 text-xs border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500 @error('number') border-red-500 @enderror @error('room_number') border-red-500 @enderror"
                        ...
                        <!-- Floor -->
                        <div>
                            <label for="floor" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                                Floor
                            </label>
                            <input type="number" id="floor" name="floor" value="{{ old('floor') }}"
                                   class="w-full px-3 py-2 text-xs border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500 @error('floor') border-red-500 @enderror"
                        ...
                        <!-- Room Type -->
                        <div>
                            <label for="room_type" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                                Room Type <span class="text-red-500">*</span>
                            </label>
                            <select id="room_type" name="room_type" class="w-full px-3 py-2 text-xs border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500 @error('room_type') border-red-500 @enderror" required>
                ...
                <div class="pt-4 border-t border-gray-100">
                    <h3 class="text-xs font-semibold text-gray-700 uppercase tracking-wider mb-3 flex items-center">
                        <i class="fas fa-ruler text-green-600 mr-1.5 text-xs"></i>
                        Room Specifications
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <!-- Capacity -->
                        <div>
                            <label for="capacity" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                                Capacity <span class="text-red-500">*</span>
                            </label>
                            <input type="number" id="capacity" name="capacity" value="{{ old('capacity', 1) }}" min="1"
                                   class="w-full px-3 py-2 text-xs border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500 @error('capacity') border-red-500 @enderror"
                        ...
                        <!-- Price / Room Cost -->
                        <div>
                            <label for="room_cost" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="room_cost" name="room_cost" value="{{ old('room_cost', old('price_per_month', old('price_per_year'))) }}" step="0.01" min="0"
                                       class="w-full pl-8 pr-3 py-2 text-xs border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500 @error('room_cost') border-red-500 @enderror @error('price_per_month') border-red-500 @enderror"
                        ...
                        <!-- Size -->
                        <div>
                            <label for="size_sqm" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                                Size (sqm)
                            </label>
                            <input type="number" id="size_sqm" name="size_sqm" value="{{ old('size_sqm') }}" step="0.01" min="0"
                                   class="w-full px-3 py-2 text-xs border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500 @error('size_sqm') border-red-500 @enderror"
                ...
                <div class="pt-4 border-t border-gray-100">
                    <h3 class="text-xs font-semibold text-gray-700 uppercase tracking-wider mb-3 flex items-center">
                        <i class="fas fa-couch text-purple-600 mr-1.5 text-xs"></i>
                        Room Features
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Gender Preference -->
                        <div>
                            <label for="gender" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                                Gender Preference <span class="text-red-500">*</span>
                            </label>
                            <select id="gender" name="gender" class="w-full px-3 py-2 text-xs border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500 @error('gender') border-red-500 @enderror" required>
                        ...
                        <!-- Window Type -->
                        <div>
                            <label for="window_type" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                                Window View
                            </label>
                            <select id="window_type" name="window_type" class="w-full px-3 py-2 text-xs border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500 @error('window_type') border-red-500 @enderror">
                ...
                <div class="pt-4 border-t border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="status" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                                Initial Status <span class="text-red-500">*</span>
                            </label>
                            <select id="status" name="status" class="w-full px-3 py-2 text-xs border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500 @error('status') border-red-500 @enderror" required>
                ...
                <div class="pt-4 border-t border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Cover Image Upload -->
                        <div>
                            <label for="cover_image" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                                Cover Image (Optional)
                            </label>
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-purple-500 transition-colors" id="cover-upload-zone">
                                <div class="text-center" id="cover-upload-prompt">
                                    ...
                                    <div class="mt-4">
                                        <label for="cover_image" class="cursor-pointer bg-white rounded-md font-medium text-purple-600 hover:text-purple-500 text-xs">
                        ...
                        <!-- Room Video Upload -->
                        <div>
                            <label for="room_video" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                                Room Video (Optional)
                            </label>
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-purple-500 transition-colors">
                                <div class="text-center">
                                    ...
                                    <div class="mt-4">
                                        <label for="room_video" class="cursor-pointer bg-white rounded-md font-medium text-purple-600 hover:text-purple-500 text-xs">
                        ...
                        <div class="md:col-span-2">
                            <label for="gallery_images" class="block text-[10px] font-medium text-gray-500 uppercase mb-1">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-purple-500 transition-colors">
                                <div class="text-center">
                                    ...
                                    <div class="mt-4">
                                        <label for="gallery_images" class="cursor-pointer bg-white rounded-md font-medium text-purple-600 hover:text-purple-500 text-xs">
                                    ...
                                    <p class="text-[10px] text-gray-500 mt-2">PNG, JPG, GIF up to 10MB each</p>
                                </div>
                            </div>
                ...
                <div class="pt-4 border-t border-gray-100">
                    ...
                    <div>
                        <textarea id="description" name="description" rows="4"
                                  class="w-full px-3 py-2 text-xs border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500 @error('description') border-red-500 @enderror"
                ...
                <div class="pt-4 border-t border-gray-100 flex items-center justify-end space-x-2">
                    ...
                    <button type="submit"
                            class="px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white text-xs font-medium rounded-lg transition flex items-center shadow-md">
