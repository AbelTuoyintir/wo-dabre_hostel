...
<head>
    ...
    <title>Login - UCC SRC HOSTEL SERVICE</title>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2">
                            <h2 class="text-3xl font-bold leading-tight">
                                ...
                                <span class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-400">Student Home</span>
                            </h2>
                            <p class="text-gray-300 text-sm leading-relaxed">
                                Sign in to manage your accommodation, connect with fellow students, 
                                and find the perfect place to call home during your studies.
                            </p>
                        </div>
                        ...
                        <div class="space-y-3 pt-4">
                            ...
                            <div class="flex items-center gap-3 text-sm text-gray-200">
                                ...
                                <span>Manage your bookings and payments</span>
                            </div>
                            <div class="flex items-center gap-3 text-sm text-gray-200">
                                <div class="w-8 h-8 bg-yellow-500/20 rounded-full flex items-center justify-center flex-shrink-0">
                                    <svg class="w-4 h-4 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-center gap-6 pt-4 border-t border-white/10">
                            <div class="flex items-center gap-2">
                                <div class="flex -space-x-2">
                                    <div class="w-8 h-8 rounded-full border-2 border-white/20 bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center text-xs font-bold text-white">S</div>
                                    <div class="w-8 h-8 rounded-full border-2 border-white/20 bg-gradient-to-br from-pink-400 to-rose-500 flex items-center justify-center text-xs font-bold text-white">J</div>
                                    <div class="w-8 h-8 rounded-full border-2 border-white/20 bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center text-xs font-bold text-white">M</div>
                                </div>
                                <span class="text-xs text-gray-400">2,000+ active students</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 animate-slide-in-right">
                        ...
                        <form method="POST" action="{{ route('login.store') }}">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button" onclick="togglePassword('password')" aria-label="Toggle password visibility" class="absolute inset-y-0 right-0 pr-3 flex items-center focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400 focus-visible:ring-offset-2 rounded-lg">
                            ...
                            <div class="mt-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                                <label for="remember_me" class="inline-flex items-center gap-2 cursor-pointer group">
                                    <input id="remember_me" type="checkbox" name="remember"
                                        class="w-4 h-4 rounded border-2 border-gray-300 text-yellow-500 shadow-sm focus:ring-yellow-500 focus:ring-2 transition-all duration-200">
                                ...
                                <a href="{{ route('password.request') }}" 
                                    class="text-xs text-yellow-600 hover:text-yellow-700 font-medium hover:underline transition-colors">
                                    Forgot password?
                                </a>
                            </div>
                        ...
                        <div class="mt-6 flex items-center justify-center gap-4">
                            <div class="flex items-center gap-1.5">
                                ...
                                <span class="text-xs text-gray-500">Secure Login</span>
                            </div>
