...
@section('page-title', 'Pay Site Security and Maintenance')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Pay Site Security and Maintenance</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        ...
        <form action="{{ route('student.payment.initialize') }}" method="POST">
            ...
            <button type="submit"
                ...
                Pay ₵{{ number_format($grandTotal, 2) }} Securely
            </button>
        </form>
