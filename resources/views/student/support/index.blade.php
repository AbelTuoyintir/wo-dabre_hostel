                ...
                <div class="space-y-4 mt-6">
                    <div class="flex items-center gap-3 bg-white/10 p-3 rounded-2xl hover:bg-white/15 transition">
                        ...
                        <div>
                            ...
                            <span class="text-sm font-extrabold">191 or 18555</span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 bg-white/10 p-3 rounded-2xl hover:bg-white/15 transition">
                        ...
                        <div>
                            <span class="block text-[10px] text-indigo-300 font-bold uppercase tracking-wider">UCC Hostels Hub Support line</span>
