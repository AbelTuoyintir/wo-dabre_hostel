        ...
        <div class="flex h-screen">
            ...
            <aside id="sidebar" class="mobile-sidebar w-72 bg-gradient-to-br from-purple-900 via-indigo-900 to-pink-900 text-white flex flex-col shadow-2xl sidebar-transition">
                ...
                <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                    ...
                    <a href="{{ route('agent.rooms.create') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:bg-white/10 {{ request()->routeIs('agent.rooms.create') ? 'bg-white/20' : '' }}">
