...
class AgentPersonaTest extends TestCase
{
    ...
    /**
     * Agent can access create room page.
     */
    ...
    /**
     * Agent can store room via store endpoint.
     */
    public function test_agent_can_store_room_via_store_endpoint(): void
    {
        $user = User::create([
        ...
        $payload = [
            ...
            'gender' => 'female',
            'status' => 'available',
            'description' => 'Executive single room for student',
            'floor' => 2,
            'size_sqm' => 20,
            'window_type' => 'street',
            'furnished' => 1,
     ...
     */
    public function test_agent_cannot_store_room_for_unowned_hostel(): void
    {
